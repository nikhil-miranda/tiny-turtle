    ...
    <section className="achievements section" id="achievements">
      ...
      <div className="achievements__container container grid">
        <div className="achievements__content">
          <div>
            <i className="uil uil-trophy achievements__icon"></i>
          ...
          >
            <div className="achievements__modal-content">
              ...
              <div className="achievements__modal-image">
                <img
                  src={performanceAwardImage}
                  className="achievements__modal-image"
                  alt="award"
                />
              </div>
              <p className="achievements__modal-description">
                This award was given for recognising the Best Performing
                Employee, for the first quarter of 2023 at Unbxd by Netcore
                Cloud.
              </p>
            </div>
          </div>
        ...
        <div className="achievements__content">
          <div>
            <i className="uil uil-cloud-check achievements__icon"></i>
          ...
          >
            <div className="achievements__modal-content">
              ...
              <p className="achievements__modal-description">
                This was an “All Age Group” hackathon and was conducted at
                Cognizant Technology Solutions, Manyata Embassy Business Park,
                Bangalore.
              </p>
        ...
        <div className="achievements__content">
          <div>
            <i className="uil uil-arrow achievements__icon"></i>
          ...
          >
            <div className="achievements__modal-content">
              ...
              <div className="achievements__modal-image">
                <img
                  src={tmcHackathonImage}
                  className="achievements__modal-image"
                  alt="award"
                />
              </div>
              <p className="achievements__modal-description">
                This Hackathon was conducted by TheMathCompany across 21
